...
var helpCommands = []helpCommand{
	...
	{Name: "handoff", Group: "COORDINATE WORK", Summary: "Transfer work and track review, integration, canary, and source cleanup evidence.", Usage: []string{"omg handoff <subcommand> [selection] [payload options]"}, Subcommands: coordinationSubs([]helpSubcommand{{Name: "create", Summary: "Create an immutable handoff with source commit/tree evidence.", Mutation: true}, {Name: "show", Summary: "Read one safe handoff and lifecycle projection."}, {Name: "history", Summary: "Read handoff history for a task."}, {Name: "lifecycle", Summary: "Read append-only integration lifecycle events."}, {Name: "advance", Summary: "Append a validated integration lifecycle event.", Mutation: true}, {Name: "supersede", Summary: "Replace a handoff through an explicit superseding record.", Mutation: true}, {Name: "accept", Summary: "Accept a submitted or reviewing handoff as an explicit decision.", Mutation: true}, {Name: "reject", Summary: "Reject a submitted or reviewing handoff as an explicit decision.", Mutation: true}, {Name: "adopt", Summary: "Adopt orphaned canonical work without destructive Git action.", Mutation: true}})},
...
func commandRequiresSubcommand(name string) bool {
	switch name {
	case "release", "agent", "migration", "backup", "board", "integration", "shell-init", "completion",
