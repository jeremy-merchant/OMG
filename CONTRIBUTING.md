...
OMG is an open-source, owner-led project. Contributions are welcome under the process below. The public source repository is not itself a promise of a stable release, support SLA, or compatibility guarantee.
...
- State whether the change affects the public module or product identity. Any identity change invalidates pinned release/parity artifacts.
