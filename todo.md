...
> Source publication status: **OPEN SOURCE / SOURCE PUBLISHED**. Stable binary release remains **NO-GO** until criterion-specific evidence, native hosted CI, and release approval are complete.
