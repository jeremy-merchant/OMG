...
var completionCommands = []string{
	"help", "init", "preflight", "doctor", "migration", "backup", "release", "version",
...
var completionValueDescriptions = map[string]map[string]string{
	...
	"handoff":     {"create": "Create an immutable handoff with evidence and risk.", "show": "Read one safe handoff projection.", "history": "Read handoff history for a task.", "supersede": "Replace a handoff through a superseding record.", "accept": "Accept a submitted handoff explicitly.", "reject": "Reject a submitted handoff explicitly.", "adopt": "Adopt orphaned canonical work."},
	...
	"board":       {"me": "Show one session and adjacent work.", "tree": "Show session and task lineage.", "task": "Show one task and adjacent coordination facts.", "all": "Show the complete safe operator snapshot.", "git": "Focus on Git observations and risks.", "tty": "Render terminal output.", "markdown": "Render Markdown output.", "html": "Render the self-contained operator board.", "json": "Render the canonical JSON view model."},
	"git":         {"inventory": "Record a safe Git inventory observation.", "current": "Read the current observation.", "latest": "Read the latest observation.", "history": "Read observation history.", "diff": "Compare two observations.", "cleanup-plan": "Produce a non-destructive cleanup plan.", "adopt": "Change canonical ownership metadata only."},
	...
	"integration": {"plan": "Preview instruction integration changes.", "apply": "Apply the reviewed integration plan.", "status": "Inspect current integration state.", "remove": "Remove only the managed integration block."},
...
var completionByCommand = map[string][]string{
	...
	"handoff":     {"create", "show", "history", "supersede", "accept", "reject", "adopt"},
	"reserve":     {"add", "list", "active", "history", "renew", "release", "override"},
	"board":       {"me", "tree", "task", "all", "git", "tty", "markdown", "html", "json"},
	"git":         {"inventory", "current", "latest", "history", "diff", "cleanup-plan", "adopt"},
	"export":      {"html", "markdown", "tty", "json"},
	"import":      {"record"},
	"integration": {"plan", "apply", "status", "remove"},
	"watch":       {"status"},
	"run":         {},
